...
# 4. Voice Config (termux-tts primary)
echo "[4/6] Voice (termux-tts-speak)..."
# Primary voice: termux-tts-speak (Android TTS)
export MORTIMER_TTS="termux-tts-speak"
if command -v termux-tts-speak &> /dev/null; then
    echo "  ✓ termux-tts-speak: PRIMARY VOICE"
    # Test voice on startup
    termux-tts-speak "Mortimer online. SEED3 systems nominal." 2>/dev/null &
fi

# Secondary: espeak (φ-modulated backup)
